...
nnoremap <silent><nowait><expr> <Tab> coc#float#has_scroll() ? coc#float#scroll(0) : "\<Tab>"
inoremap <silent><nowait><expr> <Tab> coc#float#has_scroll() ? "\<c-r>=coc#float#scroll(1)\<cr>" : "\<Right>"
inoremap <silent><nowait><expr> <Tab> coc#float#has_scroll() ? "\<c-r>=coc#float#scroll(0)\<cr>" : "\<Left>"
vnoremap <silent><nowait><expr> <Tab> coc#float#has_scroll() ? coc#float#scroll(1) : "\<Tab>"
vnoremap <silent><nowait><expr> <Tab> coc#float#has_scroll() ? coc#float#scroll(0) : "\<Tab>"
